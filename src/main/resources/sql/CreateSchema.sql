...
CREATE TABLE `cities` (
  ...
  KEY `city_country_idx` (`countryId`),
  CONSTRAINT `city_country` FOREIGN KEY (`countryId`) REFERENCES `countries` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `good_prices` (
  ...
  KEY `prices_countries_idx` (`countryId`),
  CONSTRAINT `prices_countries` FOREIGN KEY (`countryId`) REFERENCES `countries` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
